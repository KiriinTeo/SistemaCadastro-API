...
<h2 align="center" class="cor_texto"> Excluir Cadastro</h2>

<form action="exclui_cad.php" method="POST" class="form card-body row border-dark justify-content-center">
    <div class="col-lg-8 col-sm-12">
        ...
        <div class="row g-3 justify-content-center">
            <button type="submit" class="btn btn-lg cor_barra cor_texto_barra btn-block col-lg-3"> Cadastrar    
                <?php 
                $email = ':email';
